		...
		btnLogar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
				    ...
				    if (dados != null) {
				        if (ValidarJson.verificarCodigo(dados)) {
				            EventQueue.invokeLater(new Runnable() {
				                public void run() {
				                    try {
				                        ...
				                        JOptionPane.showMessageDialog(null, "Erro ao retornar para a página de Login.",
				    ...
				    JOptionPane.showMessageDialog(null, "Erro durante a execução do programa.", "Erro", JOptionPane.ERROR_MESSAGE);
				}
				...
				EventQueue.invokeLater(new Runnable() {
					public void run() {
						try {
							...
							JOptionPane.showMessageDialog(null, "Erro ao retornar para a Home Page.", "Erro",
		...
		try {
			...
			if (confirm == JOptionPane.YES_OPTION) {
				try {
					...
					JOptionPane.showMessageDialog(null, "Erro ao exluir cadastro.", "Erro", JOptionPane.ERROR_MESSAGE);
				}
			}
		} catch (IOException e) {
			JOptionPane.showMessageDialog(null, "Erro na execução do programa.", "Erro", JOptionPane.ERROR_MESSAGE);
		}
		return resposta_servidor;
	}
